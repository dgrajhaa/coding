...
/**
 * REST controller for managing {@link com.inn.ticket.reservation.domain.Movie}.
 */
@RestController
@RequestMapping("/api")
public class MovieResource {
    ...
    private static final String ENTITY_NAME = "bookingMovie";
    ...
    public ResponseEntity<Movie> createMovie(@RequestBody Movie movie) throws URISyntaxException {
        ...
        return ResponseEntity
            ...
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getMovieId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Movie> updateMovie(
        ...
        log.debug("REST request to update Movie : {}, {}", movieId, movie);
        if (movie.getMovieId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(movieId, movie.getMovieId())) {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, movie.getMovieId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Movie> partialUpdateMovie(
        ...
        log.debug("REST request to partial update Movie partially : {}, {}", movieId, movie);
        if (movie.getMovieId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(movieId, movie.getMovieId())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, movie.getMovieId().toString())
        );
    }
